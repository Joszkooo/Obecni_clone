...
namespace Obecni_clone.Server.Migrations
{
    ...
    [Migration("20240717124619_RequiredAddedAndSmallFixes")]
    partial class RequiredAddedAndSmallFixes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Obecni_clone.Server.Models.DniWolne", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Obecni_clone.Server.Models.Klient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Obecni_clone.Server.Models.Urlop", b =>
                {
                    ...
                    b.Property<double>("DlugoscUrlopu")
            ...
            modelBuilder.Entity("Obecni_clone.Server.Models.WyjazdyDoKlientow", b =>
                {
                    b.HasOne("Obecni_clone.Server.Models.Klient", "klienci")
                        .WithMany()
